    ...
    return (
        <div className="flex w-full max-w-[500px] flex-col items-center justify-center gap-4 p-4 sm:w-[500px] sm:p-8">
            <div className="flex flex-row gap-3 items-center">
                ...
                <div id="logoTag">
                    <p className="text-center text-4xl"><span className="font-bold text-orange-500" >Code</span> <br /> <span className="font-bold text-blue-400">Colab</span></p>
                    <p className="text-sm">Code, Chat and Collaborate. It's all in sync.</p>
                </div>
            </div>
